...
Resultado_vestibular::Resultado_vestibular(/* args */)
{
}

Resultado_vestibular::~Resultado_vestibular()
{
}


/*caminha na linha até a posição do curso*/
int Resultado_vestibular::busca_curso(char *vetor_de_busca, int pos_contra_barra)
{
...
*/
int Resultado_vestibular::busca_numero(char *vetor_de_busca, int pos_contra_barra, int qtde_pos, int pos_inicio)
{
...
void Resultado_vestibular::insere_no_vetor_do_curso(int *vetor_curso, char *vetor_de_busca, int pos_contra_barra, int i)
{
...
void Resultado_vestibular::ordena(int *vet, int inscritos)
{
...
void Resultado_vestibular::imprime_resultado(int *vetor_curso, int contador_curso)
{

    ordena(vetor_curso, contador_curso);

    std::cout << "--------------------------------------------" << std::endl;
    std::cout << "Aprovados Curso " << vetor_curso[3] << "\n\n";
...
void Resultado_vestibular::inicializa_resultado(){
...
void Resultado_vestibular::mostra_aprovados(){

    std::cout << std::endl;
    std::cout << "Resultado do vestibular" << std::endl;
